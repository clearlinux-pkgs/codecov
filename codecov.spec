...
Source0  : https://files.pythonhosted.org/packages/9e/7c/9d917e72196f34919f9dfc886f1955b0be91393e5627fa32bfab435e9bdf/codecov-2.1.1.tar.gz
...
%prep
%setup -q -n codecov-2.1.1
cd %{_builddir}/codecov-2.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590011090
...
cp %{_builddir}/codecov-2.1.1/LICENSE %{buildroot}/usr/share/package-licenses/codecov/061f495252a8a118c79bd9ace27758087c69f9d8
