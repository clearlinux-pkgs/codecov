...
Source0  : https://files.pythonhosted.org/packages/4b/33/9934a99571b48973d6e70e36587b8af1a27ac215269c47d88073337c029f/codecov-2.1.3.tar.gz
...
%prep
%setup -q -n codecov-2.1.3
cd %{_builddir}/codecov-2.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590369461
...
cp %{_builddir}/codecov-2.1.3/LICENSE %{buildroot}/usr/share/package-licenses/codecov/061f495252a8a118c79bd9ace27758087c69f9d8
