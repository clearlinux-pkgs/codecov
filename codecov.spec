...
Source0  : https://files.pythonhosted.org/packages/3b/0b/71483000915db929d1ff98037d25fff14d6deb112000ebf181cb02b38c16/codecov-2.0.21.tar.gz
...
%prep
%setup -q -n codecov-2.0.21
cd %{_builddir}/codecov-2.0.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584488660
