...
Source0  : https://files.pythonhosted.org/packages/71/b6/9e39d6dad47f66aa256d25f506f221bf8940285a78fb928c33a9d6ade145/codecov-2.1.0.tar.gz
...
%prep
%setup -q -n codecov-2.1.0
cd %{_builddir}/codecov-2.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589828682
...
cp %{_builddir}/codecov-2.1.0/LICENSE %{buildroot}/usr/share/package-licenses/codecov/061f495252a8a118c79bd9ace27758087c69f9d8
